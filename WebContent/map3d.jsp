...
<!-- 
<link rel="stylesheet" href="http://192.168.2.201/arcgis_js_api/4.3/esri/css/main.css" />
<script src="http://192.168.2.201/arcgis_js_api/4.3/init.js"></script> 
 -->
...
<link rel="stylesheet" href="map3d.css?time=<%=System.currentTimeMillis() %>" />
<script src="map3d-config.js?time=<%=System.currentTimeMillis() %>"></script>
<script src="map3d.js?time=<%=System.currentTimeMillis() %>"></script>
</head>
...
<body>
	...
	<div id="header" class="header">
		...
		<div class="subtitle">Powered by www.asiacom-online.com</div>


		<div id="toolbar-item-chart" class="toolbar-item" title="报表"
